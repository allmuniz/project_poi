package project.poi.controllers;

import org.springframework.data.domain.Page;
import org.springframework.data.domain.PageRequest;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import project.poi.controllers.dto.CreatePointOfInterest;
...
public class PointOfInterestController {
    ...
    public ResponseEntity<Void> createPoi(@RequestBody CreatePointOfInterest body){
        repository.save(new PointOfInterestEntity(body.name(), body.x(), body.y()));
        return ResponseEntity.ok().build();
    }

    @GetMapping("/points-of-interest")
    public ResponseEntity<Page<PointOfInterestEntity>> ListPoi(@RequestParam(name = "page", defaultValue = "0") Integer page,
    ...
    @GetMapping("/near-me")
    public ResponseEntity<List<PointOfInterestEntity>> NearMePoi(@RequestParam("x") Long x,
